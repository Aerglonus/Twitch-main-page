...
export const Modal = () => {
	...
	return (
		<>
			<button
				className="hover:transition-colors hover:duration-500 transition-all duration-200 ease-in-out hover:ease-in-out h-[30px] w-[58.13px]  rounded bg-[#f2f2f2] hover:bg-[#e5e5e5] dark:bg-[#333336] dark:hover:bg-[#464649] text-black dark:text-white text-sm  font-Roobert"
				type="button"
